...
class Bill extends Detail{
	int n; double amt;
 	Bill(String n1, String a, String t, double d, int c){
   		super(n1,a,t,d); n=c; amt=0;
   	}
  	void call(){
  		int n1; amt=rent; n1=n; n1=n1-100;
		if(n1>0 && n1<=100) amt=amt+n1*.6; n1=0;
 		else amt=amt+100*.6; n1=n1-100;
		if(n1>0 && n1<=100)amt=amt+n1*.8; n1=0;
	 	else amt=amt+100*.8; n1=n1-100;
		if(n1>0) amt=amt+n1*.1;
	}
 	void show(){
 	...
 	public static void main(String args[]) throws Exception{
 		Bill ob; String n,a,t; double rent;	int call;
		BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
	 	System.out.print("\nEnter Customer Name:"); n=br.readLine();
	 	System.out.print("\nEnter Address:"); a=br.readLine();
	 	System.out.print("\nEnter Telephone Number:"); t=br.readLine();
	 	System.out.print("\nEnter Rent:"); rent=Double.parseDouble(br.readLine());
	 	System.out.print("\nEnter Total Calls:"); call=Integer.parseInt(br.readLine());
	 	ob=new Bill(n,a,t,rent,call); ob.call(); ob.show();
 	}
}
// ------------------------------------{END OF THE CODE}-----------------------------------------